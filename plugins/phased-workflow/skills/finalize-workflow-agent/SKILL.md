...
**Base skill: finalize-workflow.** This agent runs its Step 4 review criteria unattended and returns the findings; it adds only the unattended constraints below. **Shared conventions:** `${CLAUDE_PLUGIN_ROOT}/refs/common.md`.
