...
- [x] **Phase 1**: implement truncate_words
  ...
  > Done: `python3 -m pytest tests/ -q` → 10 passed; `python3 -m flake8 textutils/truncate.py tests/test_truncate.py` → zero errors. Independent phase-verifier review: no findings.
  > Files: textutils/truncate.py, tests/test_truncate.py
